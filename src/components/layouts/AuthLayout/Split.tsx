                ...
                <div className="flex flex-col items-center gap-12">
                    ...
                    <div className="text-center max-w-[550px]">
                        ...
                        <p className="text-neutral opacity-80 mx-auto mt-8 font-semibold">
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Earum nisi nam possimus consequuntur minima, laboriosam numquam corrupti. Repudiandae, enim modi facilis ex porro explicabo ea, harum, natus hic odio possimus?
                        </p>
                    </div>
                </div>
            </div>
